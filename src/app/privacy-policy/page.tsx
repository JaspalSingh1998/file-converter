export default function PrivacyPolicy() {
  return (
    <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
      <p>Effective Date: Thursday 2 Nov, 2023</p>
      <p>
        At Alterigo, we are committed to safeguarding your privacy. This Privacy
      ...
      <div className="space-y-2">
        ...
        <p>
          ...
          jaspalsingmac@gmail.com.
        </p>
      </div>

      <p>
        By using Alterigo, you agree to the practices outlined in this Privacy
